...
const CartClient: React.FC<CartClientProps> = ({currentUser}) => {
    ...
    return <div>
        ...
        <div className="border-t-[1.5px] text-slate-500 py-4 flex justify-between gap-4 text-base">
            ...
            <div className="text-sm flex flex-col gap-1 items-center text-slate-500">
                    <div className="flex justify-between w-full text-base font-semibold text-slate-500">
                       <span>Subtotal</span> 
